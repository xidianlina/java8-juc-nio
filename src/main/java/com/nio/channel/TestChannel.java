...
public class TestChannel {
    ...
    public void test2() throws IOException {
        ...
        MappedByteBuffer outMappedBuf = outChannel.map(MapMode.READ_WRITE, 0, outChannel.size());
    ...
    public void test3() throws IOException {
        FileChannel inChannel = FileChannel.open(Paths.get(""), StandardOpenOption.READ);
        FileChannel outChannel = FileChannel.open(Paths.get(""), StandardOpenOption.WRITE, StandardOpenOption.READ, StandardOpenOption.CREATE_NEW);
